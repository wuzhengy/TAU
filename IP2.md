...
There are three message types: query, response, and error. A message is a single dictionary with three keys common to every message and additional keys depending on the type of message. 
