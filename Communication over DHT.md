...
## XX Channel
* a mutable item the public key node sync up with its devices: timestamp, friends list and own messages
* third party can send life signal appendix to XX channel with minimum data
  * third party public key - 32 bytes
  * 4 bytes opt code
* in net, this could help increase efficiency to add friends. 
